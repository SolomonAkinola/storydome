...
<section class="home-grid">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p>stories liked : <span><?= $total_user_likes; ?></span></p>
      ...
      <div class="box">
         ...
         ?>
            <a href="author_stories.php?author=<?= $fetch_authors['name']; ?>" class="links"><?= $fetch_authors['name']; ?></a>
            <?php
            }
         }else{
         ...
         ?>  
         <a href="storytellers.php" class="btn">view all</a>
         </div>
      </div>
...
<section class="posts-container">
   ...
   <h1 class="heading">latest stories</h1>
   ...
   <div class="box-container">
      ...
      <form class="box" method="post">
         ...
         <div class="post-admin">
            ...
            <div>
               <a href="author_stories.php?author=<?= $fetch_posts['name']; ?>"><?= $fetch_posts['name']; ?></a>
         ...
         <a href="view_stories.php?post_id=<?= $post_id; ?>" class="inline-btn">read more</a>
         <a href="category.php?category=<?= $fetch_posts['category']; ?>" class="post-cat"> <i class="fas fa-tag"></i> <span><?= $fetch_posts['category']; ?></span></a>
         <div class="icons">
            <a href="view_stories.php?post_id=<?= $post_id; ?>"><i class="fas fa-comment"></i><span>(<?= $total_post_comments; ?>)</span></a>
   ...
   <div class="more-btn" style="text-align: center; margin-top:1rem;">
      <a href="stories.php" class="inline-btn">view all stories</a>
   </div>
