...
<section class="read-post">
   ...
   <form method="post">
      ...
      <div class="flex-btn">
         <a href="edit_story.php?id=<?= $post_id; ?>" class="inline-option-btn">edit</a>
         <button type="submit" name="delete" class="inline-delete-btn" onclick="return confirm('delete this story?');">delete</button>
         <a href="view_stories.php" class="inline-option-btn">go back</a>
      </div>
   </form>
   <?php
         }
