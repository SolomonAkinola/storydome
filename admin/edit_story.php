...
<section class="post-editor">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <p>title <span>*</span></p>
      <input type="text" name="title" maxlength="100" required placeholder="story title" class="box" value="<?= $fetch_posts['title']; ?>">
      ...
      <div class="flex-btn">
         ...
         <a href="view_stories.php" class="option-btn">go back</a>
         <input type="submit" value="delete story" class="delete-btn" name="delete_post">
      </div>
   </form>
   ...
   <?php
         ...
         echo '<p class="empty">no stories found!</p>';
   ?>
   <div class="flex-btn">
      <a href="view_stories.php" class="option-btn">view stories</a>
      <a href="add_stories.php" class="option-btn">add stories</a>
   </div>
   <?php
      }
   ?>
