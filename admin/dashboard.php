...
<section class="dashboard">
   ...
   <div class="box">
      ...
      <p>stories added</p>
      <a href="add_stories.php" class="btn">add new story</a>
   </div>
   ...
   <div class="box">
      ...
      <p>active stories</p>
      <a href="view_posts.php" class="btn">see stories</a>
   </div>
   ...
   <div class="box">
      ...
      <p>inactive stories</p>
      <a href="view_stories.php" class="btn">see stories</a>
   </div>
   ...
   <div class="box">
      ...
      <p>Story Tellers</p>
      <a href="admin_accounts.php" class="btn">see story tellers</a>
   </div>
