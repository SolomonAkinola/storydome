...
<section class="show-posts">
   ...
   <div class="box-container">
      ...
      <form method="post" class="box">
         ...
         <div class="flex-btn">
            <a href="edit_story.php?id=<?= $post_id; ?>" class="option-btn">edit</a>
            <button type="submit" name="delete" class="delete-btn" onclick="return confirm('delete this story?');">delete</button>
         </div>
         <a href="read_stories.php?post_id=<?= $post_id; ?>" class="btn">view story</a>
      </form>
      <?php
            }
         }else{
