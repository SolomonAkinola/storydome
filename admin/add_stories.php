...
<section class="post-editor">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <p>title <span>*</span></p>
      <input type="text" name="title" maxlength="100" required placeholder="story title" class="box">
      <p>content <span>*</span></p>
      <textarea name="content" class="box" required maxlength="10000" placeholder="add content..." cols="30" rows="10"></textarea>
      ...
      <div class="flex-btn">
         <input type="submit" value="publish story" name="publish" class="btn">
